This project is a simple language converter built using HTML, CSS, and JavaScript. It allows users to convert text from one language to another using a predefined set of languages.
Features :
